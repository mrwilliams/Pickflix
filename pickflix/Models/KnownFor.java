 ...
 */
@Parcel
public class KnownFor extends ArrayListParcelConverter<KnownFor> {
    ...
    @Override
    public void itemToParcel(KnownFor input, android.os.Parcel parcel) {
        parcel.writeParcelable(Parcels.wrap(input), 0);
    }

    @Override
    public KnownFor itemFromParcel(android.os.Parcel parcel) {
